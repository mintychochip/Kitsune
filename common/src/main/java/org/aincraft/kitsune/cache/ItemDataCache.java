 ...
 * Avoids redundant JSON parsing of the same item data during search result processing.
 */
public class ItemDataCache {
    ...
    public static class ExtractedItemData {
        ...
        public ExtractedItemData(String displayName, int slotIndex, int amount, ContainerPath containerPath) {
        ...
        public ContainerPath getContainerPath() { return containerPath; }
    }
