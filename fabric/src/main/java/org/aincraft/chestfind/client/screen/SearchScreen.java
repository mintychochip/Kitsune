...
public class SearchScreen extends Screen {
    ...
    public SearchScreen() {
        super(Text.translatable("gui.chestfind.search.title"));
    }
    ...
    protected void init() {
        ...
        searchBox = new TextFieldWidget(
                ...
                SEARCH_BOX_WIDTH,
                SEARCH_BOX_HEIGHT,
                Text.translatable("gui.chestfind.search.placeholder")
        );
        ...
        searchButton = ButtonWidget.builder(
                        Text.translatable("gui.chestfind.search.button"),
    ...
    private void performSearch() {
        ...
        NetworkHandler.sendSearchRequest(query, 10);
