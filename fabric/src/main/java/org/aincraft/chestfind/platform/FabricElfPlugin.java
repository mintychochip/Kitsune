...
import org.aincraft.chestfind.ElfPlugin;
...
/**
 * Fabric implementation of ElfPlugin.
 * Provides platform abstractions for the common module.
 */
public final class FabricElfPlugin implements ElfPlugin {
    private final Logger logger;
    private final Path dataFolder;
    private final FabricConfigProvider configProvider;

    public FabricElfPlugin(Path configDir, FabricConfigProvider configProvider) {
        this.logger = new Slf4jLoggerWrapper("ChestFind");
        this.dataFolder = configDir.resolve("chestfind");
