...
import org.aincraft.kitsune.client.screen.SearchResultsScreen;
...
public class ClientSearchResultHandler {
    private static List<SearchResult> lastResults = List.of();

    private ClientSearchResultHandler() {
    }
    ...
    public static void handleResults(List<SearchResult> results) {
        ...
        for (SearchResult result : results) {
            ...
            int color = getColorForScore((float) result.score());
